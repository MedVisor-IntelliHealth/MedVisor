...
// Mock data for medication recommendations
...
interface AddMedicationFormProps {
  isOpen: boolean
  onClose: () => void
  patientConditions: Array<{ name: string; since: string; status: string }>
  patientLabResults: Array<{
    date: string
    type: string
    results: Array<{ name: string; value: string; unit: string; range: string; status: string }>
  }>
}
...
export function AddMedicationForm({ isOpen, onClose, patientConditions, patientLabResults }: AddMedicationFormProps) {
  ...
  const getRecommendations = () => {
    ...
    return medicationRecommendations[selectedCondition as keyof typeof medicationRecommendations] || []
  }
